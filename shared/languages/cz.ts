export const CZ = {
   ...
   AccountTradeTileReservationTimeDesc: "Toto je doba, po kterou pro vás bude rezervována obchodní políčko vašeho hráče od vaší poslední návštěvy online. Po uplynutí doby rezervace bude vaše políčko k dispozici ostatním hráčům.",
   ...
   AdvisorHappinessContent:
      "Spokojenost je v CivIdle klíčovou mechanikou limitující rozvoj. Spokojenost získáváš odemykáním nových technologií, postupem do nových období, stavením divů světa, od osobností poskytující spokojenost nebo několika dalšími způsoby, na které během času narazíš. <b>Každá nová budova stojí 1 spokojenost</b>. Za každý kladný bod spokojenosti spokojenosti získáš 2% pracovníků navíc, ale stejně tak to platí pro každý bod spokojenosti pod 0. Každý bod spokojenosti nad 50 nebo pod -50 již nemá další vliv na tento systém. Detailní přehled spokojenosti najdeš v <b>sekci spokojenosti v hlavní budově</b>.",
   AdvisorHappinessTitle: "Udržuj populaci spokojenou",
   AdvisorOkay: "Rozumím, díky!",
   ...
   AldersonDiskDesc: "+25 spokojenosti. Tento div může být dále vylepšován a každé další vylepšení zvýší bonus spokojenosti o 5.",
   Alloy: "Slitina",
   Alps: "Alpy",
   AlpsDesc: "Každá 10. úroveň budovy získá +1 výrobní kapacitu (+1 multiplikátor spotřeby, +1 multiplikátor výroby).",
   Aluminum: "Hliník",
   ...
   AngkorWatDesc: "Všechny přilehlé budovy získají multiplikátor +1 k pracovní kapacitě. Poskytují 1000 dělníků",
   ...
   ApolloProgramDesc: "Všechny raketové továrny získají +2 multiplikátor produkce, kapacity pracovníků a skladovacích prostor. Satelitní továrny, továrny na kosmické lodě a sila na jaderné střely dostanou za každou sousední raketovou továrnu výrobní multiplikátor +1.",
   ApplyToAll: "Použít pro všechny",
   ApplyToAllBuilding: "Použít na všechny %{building}",
   ApplyToBuildingInTile: "Použít na všechny %{building} V rámci %{tile} políčko",
   ...
   BankingAdditionalUpgrade: "Všechny budovy, které jsou na úrovni 10 nebo vyšší, získají multiplikátor +1 k úložišti.",
   Banknote: "Bankovky",
   BaseCapacity: "Base Capacity",
   BaseConsumption: "Základní spotřeba",
   BaseMultiplier: "Základní multiplikátor",
   ...
   BrandenburgGateDesc: "Všechny uhelné doly a ropné vrty získávají +1 multiplikátor produkce, skladování a kapacity pracovníků. Ropné rafinerie získávají +1 multiplikátor produkce, skladování a kapacity pracovníků za každou sousední destičku s ropou.",
   Bread: "Chléb",
   Brewery: "Pivovar",
   Brick: "Cihla",
   Brickworks: "Cihelna",
   ...
   Caravel: "Karavela",
   CaravelBuilder: "Loděnice pro karavely",
   ...
   ChichenItzaDesc: "Všechny přilehlé budovy získají multiplikátor +1 k produkci, skladování a kapacitě dělníků.",
   Chinese: "Chinese",
   ...
   CircusMaximusDescV2: "+5 Spokojenost. Všechny cechy hudebníků, spisovatelů a malířů získávají +1 multiplikátor produkce a skladování.",
   ...
   CNTower: "CN Tower",
   CNTowerDesc: "Všechna filmová studia, rozhlasové stanice a televizní stanice jsou osvobozeny od daně z příjmu -1. Všechny budovy odemčené ve světových válkách a studené válce získávají +N multiplikátor produkce, kapacity pracovníků a skladů. N = rozdíl mezi úrovní a stářím budovy.",
   Coal: "Uhlí",
   CoalMine: "Uhelný důl",
   ...
   ColossusOfRhodesDesc: "Všechny přilehlé budovy, které neprodukují pracovníky, získají +1 spokojenost",
   ...
   ForbiddenCityDesc: "Všichni výrobci papíru, cechy spisovatelů a tiskárny získají +1 multiplikátor produkce, kapacity pracovníků a skladování.",
   Forex: "Forex",
   ...
   Galleon: "Galeona",
   GalleonBuilder: "Loděnice pro Galeony",
   Gameplay: "Hra",
   Garment: "Oděv",
   ...
   Glass: "Sklo",
   Glassworks: "Sklárna",
   GlobalBuildingDefault: "Obecné výchozí nastavení budov",
   ...
   GrandBazaarDesc: "Ovládejte všechny trhy na jednom místě!. Všechny sousední budovy získají multiplikátor +5 ke skladování.",
   ...
   HangingGardenDesc: "Multiplikátor kapacity stavitele +1. Sousední akvadukty získávají multiplikátor +1 k produkci, skladování a kapacitě dělníků.",
   Happiness: "Spokojenost",
   HappinessFromBuilding: "budovy (kromě divů)",
   HappinessFromBuildingTypes: "dobře zásobené budovy",
   HappinessFromHighestTierBuilding: "budova nejvyšší úrovně",
   HappinessFromUnlockedAge: "odemčená doby",
   HappinessFromUnlockedTech: "odemčené technologie",
   HappinessFromWonders: "divy (včetně přírodních)",
   HappinessUncapped: "Spokojenost (neomezená)",
   HarryMarkowitz: "Harry Markowitz",
   HarunAlRashid: "Harún al-Rašíd",
   Hatshepsut: "Hatshepsut",
   HatshepsutTemple: "Chrám Hatšepsut",
   HatshepsutTempleDesc: "Odhalí všechna vodní políčka na mapě. Pšeničná pole získají +1 multiplikátor produkce za každou vodní destičku sousedící s farmou.",
   ...
   HimejiCastleDesc: "Všiechny loděnice karavel, galeon a fregat získají bonus +1 k výrobě, kapacity pracovníků a skladování.",
   Hollywood: "Hollywood",
   ...
   Ironclad: "Obrněnec",
   IroncladBuilder: "Loděnice pro obrněnce",
   ...
   LighthouseOfAlexandriaDesc: "Všechny přilehlé budovy získají multiplikátor +5 za skladování",
   ...
   NeuschwansteinDesc: "+10 multiplikátor kapacity stavitele při stavbě divů",
   Newspaper: "Noviny",
   ...
   NoDepositDesc: "Na tuto dlaždici není požadován žádný ložisko. Další ložiskoy mohou být objeveny při odemykání nových technologií",
   ...
   PersepolisDesc: "Všechny měděné těžební tábory, dřevařské tábory a kamenolomy získají +1 multiplikátor produkce, kapacity pracovníků a skladování",
   ...
   PlayerMapClaimTileCondition4: "Nevyžádali jste si dlaždici nebo jste překročili cooldown pro přesunutí políčko",
   PlayerMapClaimTileCooldownLeft: "Zbývající doba platnosti: %{time}",
   PlayerMapClaimTileNoLongerReserved: "Tato políčko již není rezervovaná. Můžete vystěhovat <b>%{name}</b> a nárokovat si tuto dlaždici pro sebe.",
   ...
   PlayerMapUnclaimedTile: "Nevyzvednutá políčko",
   ...
   PlayerTradeClaimTileFirst: "Reklamace políčko na obchodní mapě",
   ...
   Progress: "Pokrok",
   ProgressTowardsNextGreatPerson: "Postup k další osobnosti při znovuzrození",
   ...
   PyramidOfGizaDesc: "Všechny budovy, které produkují dělníky, získají +1 výrobní multiplikátor",
   QinShiHuang: "Čchin Š'-chuang",
   Radio: "Radio",
   RadioStation: "Radio Station",
   Railway: "Železnice",
   RamessesII: "Ramses II.",
   RamessesIIDesc: "+%{value} Multiplikátor kapacity stavitelů",
   ...
   ResourceBarShowUncappedHappiness: "Ukázat neomezenou spokojenost",
   ...
   RijksmuseumDesc: "+5 spokojenost. Všechny budovy, které využívají nebo vyrábějí kulturu získávají +1 k produkci, skladování a kapacitě pracovníků.",
   ...
   SaintBasilsCathedralDescV2: "Povolení staveb pro těžbu surovin v sousedství ložiska. Všechny budovy I. úrovně získají multiplikátor +1 k produkci, multiplikátor kapacity pracovníků a multiplikátor skladování.",
   Saladin: "Saladin",
   ...
   ShortcutScopeEmptyTilePage: "Stránka s prázdnými políčkomi",
   ...
   SiegeRam: "Beranidlo",
   SiegeWorkshop: "Dílna na beranidla",
   Silicon: "Silicon",
   ...
   StatueOfLibertyDesc: "Všechny sousední budovy získají +N multiplikátor produkce, skladovací kapacity a kapacity dělníků. N = počet sousedních budov stejného typu.",
   StatueOfZeus: "Diova socha",
   StatueOfZeusDesc: "Vyvolá náhodná naleziště, která byla odhalena na sousedních prázdných destičkách. Všechny sousední budovy I. úrovně získají multiplikátor +5 k produkci a skladování.",
   ...
   StonehengeDesc: "Všechny budovy, které spotřebovávají nebo produkují kámen, získávají +1 produkční multiplikátor.",
   ...
   SummerPalaceDesc: "Všechny sousední budovy, které využívají nebo vyrábějí střelný prach, jsou osvobozeny od -1 spokojenosti. Všechny budovy, které využívají nebo vyrábějí střelný prach, získávají +1 k produkci, skladování a kapacitě dělníků.",
   ...
   TempleOfArtemisDesc: "Všechny kovárny mečů a zbrojnice získají po dokončení +5 úrovní. Všechny kovárny mečů a zbrojnice získají +1 multiplikátor produkce, kapacity dělníků a skladování.",
   TempleOfHeaven: "Chrám nebes",
   TempleOfHeavenDesc: "Všechny budovy, které jsou na úrovni 10 nebo vyšší, získají multiplikátor +1 Kapacita dělníků.",
   TempleOfPtah: "Temple of Ptah",
   TerracottaArmy: "Terakotová armáda",
   TerracottaArmyDesc: "Všechny tábory pro těžbu železa získají +1 multiplikátor produkce, kapacity dělníků a skladování. Železné kovárny získají +1 multiplikátor produkce za každý sousední tábor těžby železa.",
   ...
   UnexploredTile: "Neprobádané políčko",
   ...
   WarehouseUpgradeDesc: "Volná přeprava mezi tímto skladem a jeho sousedními políčkomi.",
   Warp: "Warp",
   ...
   WonderUpgradeLevel: "Úroveň divu světa",
   Wood: "Dřevo",
   Worker: "Pracovník",
   WorkerCapacityMultiplier: "Multiplikátor kapacity pracovníků",
   WorkerHappinessPercentage: "Procento spokojenosti",
   WorkerMultiplier: "Kapacita pracovníků",
   WorkerPercentagePerHappiness: "%{value}% Multiplikátor pro každé štěstí",
   Workers: "Pracovníci",
   WorkersAvailableAfterHappinessMultiplier: "Pracovníci po multiplikaci spokojenosti",
   WorkersAvailableBeforeHappinessMultiplier: "Pracovníci před multiplikací spokojenosti",
   WorkersBusy: "Využití pracovníci",
   ...
   WorldWarAge: "Období světových válek",
   WorldWideWeb: "World Wide Web",
   WritersGuild: "Cech spisovatelů",
   Writing: "Psaní",
   WuZetian: "Císařovna Wu Zetian",
   WuZetianDesc: "+%{value} Multiplikátor přepravní kapacity",
   Xuanzang: "Xuanzang",
   YangtzeRiver: "Yangtze River",
   YangtzeRiverDesc: "Všechny budovy, které spotřebovávají vodu, získají multiplikátor +1 k produkci, kapacitě pracovníků a skladování. Dvojnásobný účinek Zheng He (osobnost). Každá úroveň stálé císařovny Wu Zetian (osobnost) přináší všem budovám multiplikátor +1 k multiplikátori skladování.",
   YellowCraneTower: "Žlutá jeřábová věž",
   YellowCraneTowerDesc: "+1 volba při výběru skvělých lidí. Všechny budovy v dosahu 1 políčko získají +1 multiplikátor produkce, kapacity pracovníků a skladů. Při stavbě vedle řeky Jang-c'-ťiang se dosah zvyšuje na 2 políčko.",
